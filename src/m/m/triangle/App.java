...
public class App {
    ...
    Podane wartości to długości boków. Program ma rozpoznawać czy wprowadzony został trójkąt,
     czworokąt, pięciokąt czy sześciokąt.
...
- SzesciokatForemny
    ...
    Po utworzeniu odpowiednich obiektów program wypisuje w pętli co zostało stworzone,
     jakie są długości boków utworzonej figury, jaki jest obwód tej figury oraz w przypadku jeśli jest to:
  - dowolny trójką
- kwadrat
- prostokąt
- pięciokąt foremny
